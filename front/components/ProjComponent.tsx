...
const ProjComponent: FC = () => {
    ...
    const projects : ProjectData[] = [
        new ProjectData("Algorithme d'estimation de chiffre d'affaire", "Logiciel permettant d'estimer un chiffre d'affaire en fonction de paramètres et de données basées sur une année précédente", "Professionnel", "2024", "-", [".Net", "Rust","GTK", "SQLite"], false),
        ...
        new ProjectData("Projet Tabletop", "Développement d'un jeu indépendant type JDR/RPG dans un univers Médiéval Fantastique avec une esthétique de jeu de plateau.", "OuterGames", "2023", "-", ["UnrealEngine", "C++"], false),
        ...
        new ProjectData("Application Mobile", "Développement d'une application mobile en rapport avec le réseau de transport de Colmar", "Professionnel", "2022", "-", ["Dotnet MAUI Hybrid Blazor", "ASP.Net Web API", "TailwindCSS","PostgresSQL", "Docker"], false),
