...
const ProjComponent: FC = () => {
    ...
    const projects : ProjectData[] = [
        new ProjectData("Jeu Concours TraceXFav 2023", "Jeu concours réalisé à l'occasion de la Foire Aux Vins de Colmar 2022 afin de faire remporter des places de concert aux participants", "Professionnel", "2023", "-", ["UnityEngine", "ASP.Net WepAPI", "PostgresSQL", "Docker"], true),
        new ProjectData("MiniFactory", "Développement d'un jeu de création d'usine.", "Personnel", "2023", "-", ["UnrealEngine", "C++"], true),
        new ProjectData("Projet Tabletop", "Développement d'un jeu indépendant type JDR/RPG en équipe", "OuterGames", "2023", "-", ["UnrealEngine", "C++"], true),
